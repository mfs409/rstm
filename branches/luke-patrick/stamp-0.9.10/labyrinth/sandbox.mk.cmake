...
test.cgl: labyrinth
	...
	do \
		...
		STM_CONFIG=CGL taskset -c ${CPUSET} ./$< -t1 -i @CMAKE_CURRENT_SOURCE_DIR@/inputs/random-x256-y256-z5-n256.txt; \
	done
	...
	do \
		...
		do \
			...
			do \
				...
				STM_CONFIG=$$stm taskset -c ${CPUSET} ./$< -t$$i -i @CMAKE_CURRENT_SOURCE_DIR@/inputs/random-x256-y256-z5-n256.txt; \
			done \
		done \
	done
