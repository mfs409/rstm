...
#error "Unable to determine Instrumentation mode"
  ...
  THREAD_LOCAL_FUNCTION_DECL_TYPE(TM_FASTCALL void(*)(TX_LONE_PARAMETER), tmcommit);
  THREAD_LOCAL_FUNCTION_DECL_TYPE(TM_FASTCALL void*(*)(TX_FIRST_PARAMETER STM_READ_SIG(,)), tmread);
  THREAD_LOCAL_FUNCTION_DECL_TYPE(TM_FASTCALL void(*)(TX_FIRST_PARAMETER STM_WRITE_SIG(,,)), tmwrite);
#else
